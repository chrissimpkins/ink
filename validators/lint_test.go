...
func TestLintTemplateSuccessValidTemplate(t *testing.T) {
	result, _ := LintTemplateSuccess("../testfiles/template_1.txt.in")
	if result == false {
...
func TestLintTemplateSuccessInvalidTemplate(t *testing.T) {
	result, _ := LintTemplateSuccess("../testfiles/template_2.txt.in")
	if result == true {
...
func TestLintTemplateSuccessBadFilePath(t *testing.T) {
	result, err := LintTemplateSuccess("../testfiles/bogusfile.txt")
	if result == true {
